...
import 'package:dummy1/Widgets/reAuthenticate_user_login_form.dart';
...
class UserController extends GetxController {
  ...
  void  deleteAccountWarningPopup() {
    Get.defaultDialog(
      ...
      confirm: ElevatedButton(style: ElevatedButton.styleFrom(
  ...
  void deleteUserAccount()async{
    try {
      FullScreenLoader.openLoadingDialog("Processing", "assets/images/success/141594-animation-of-docer.json");
  ...
  uploadUserProfilePicture()async {
    ...
    if (image != null) {
      ...
      user.refresh();
      SnackBars.SuccessSnackBar(title: "Congratulations!",message: "Your profile Image is updated successfully");
    }
  } catch(e){
