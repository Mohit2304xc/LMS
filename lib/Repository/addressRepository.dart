...
class AddressRepository extends GetxController {
  ...
  Future<List<AddressModel>> fetchUserAddresses() async {
    try {
      ...
      if (userId
          .isEmpty) throw 'Unable to find User information.Try again later.';
  ...
  Future<void> updateSelectedField(String addressId,bool selected ) async {
    try {
      ...
      await _db.collection('Users').doc(userId).collection(
          'Addresses').doc(addressId).update({'SelectedAddress':selected});
